    ...
    <>
      <div id="Skills" style={{ backgroundImage: `url(${bgpic})` }} className="w-screen h-screen bg-cover bg-no-repeat bg-center ">
        ...
        <div className=" flex flex-wrap items-center justify-center  ">
          ...
          <div className="font-normal skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28   rounded text-center flex items-center justify-center shadow-lg border-blue-700 m-4">
            <div>
              <img
          ...
          <div className=" font-normal skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28  rounded text-center flex items-center justify-center shadow-lg border-blue-700 m-4">
            <div>
              <img
                className="h-6 w-6 sm:md:lg:h-10 sm:md:lg:w-10 bg-cover  "
                src={Pic2}
                alt="CSS"
              />
              <div>
          ...
          <div className=" font-medium skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28 sm:md:lg:w-24  rounded text-center flex flex-col items-center justify-center shadow-lg border-blue-700 m-4">
            <div>
              <img
                className="h-6 w-6 sm:md:lg:h-10 sm:md:lg:w-10 bg-cover  "
                src={Pic3}
          ...
          <div className="  skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28  rounded text-center flex items-center justify-center shadow-lg border-blue-700 m-4">
            <div>
              <img
                className="h-6 w-6 sm:md:lg:h-10 sm:md:lg:w-10 bg-cover  "
                src={Pic4}
          ...
          <div className="  skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28  rounded text-center flex flex-col items-center justify-center shadow-lg border-blue-700 m-4">
          ...
          <div className="skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28 sm:md:lg:w-24  rounded text-center flex items-center justify-center shadow-lg border-blue-700 m-4">
            <div>
              <img
                className="h-6 w-6 sm:md:lg:h-10 sm:md:lg:w-10 bg-cover  "
                src={Pic15}
          ...
          <div className=" skill h-16 w-16 sm:md:h-20 sm:md:w-20 lg:xl:h-28  lg:xl:w-28 sm:md:lg:w-24  rounded text-center flex items-center justify-center shadow-lg border-blue-700 m-4">
            <div>
              <img
                className="h-6 w-6sm:md:lg:h-10 sm:md:lg:w-10 bg-cover  "
                src={Pic5}
                alt="C++"
              />
              <div>
